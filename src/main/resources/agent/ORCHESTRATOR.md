...
| Pregunta de análisis, insights, patrones, anomalías, weekday vs weekend | Invocar analyze_patterns |
...
- Interpreta el insight con contexto de negocio cuando aplique
- Formato limpio y conciso
- Para analyze_patterns: estructura la respuesta con los hallazgos más relevantes primero
